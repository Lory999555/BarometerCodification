...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); //probabilmente per il restore dello stato di qualcosa anche se siamo nell'onCreate()
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent i = new Intent(PressActivity.this, PlaySound.class);
                // startActivity(i);
                //button.setText("Benimia");
                //progess.setText("Prova2");
